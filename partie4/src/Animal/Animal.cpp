...
: OrganicEntity(position_, taille, energie), tempsPause(sf::Time::Zero), tempsEnceinte (sf::Time::Zero), normeVitesse(0.001), femelle(sexe), state(Etat::WANDERING), nbBabies (0), cible(nullptr), mate(nullptr)
{													
	direction.x = 1.0;
	direction.y = 0.0;
	currentTarget.x = 1.0; 
