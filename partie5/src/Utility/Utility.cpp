...
Arc buildArc(double start, double end, double radius, Vec2d origin, sf::Color color, float rotation, float thickness)
{
    Arc arc(start, end, radius,color, (thickness < 0. ? radius : thickness));
