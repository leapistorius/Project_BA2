...
// food generator
    ...
    , object_generator_delta (mConfig["simulation"]["object generator"]["delta"].toDouble())
// food
...
//mushroom 
    ,mushroom_texture(mConfig["simulation"]["mushroom"]["texture"].toString())
    ,mushroom_size(mConfig["simulation"]["mushroom"]["size"].toDouble())
    ,mushroom_energy(mConfig["simulation"]["mushroom"]["energy"].toDouble())
    ,mushroom_lossEnergy(mConfig["simulation"]["mushroom"]["lossEnergy"].toDouble())
//banana 
    ,banana_texture(mConfig["simulation"]["banana"]["texture"].toString())
    ,banana_size(mConfig["simulation"]["banana"]["size"].toDouble())
    ,banana_energy(mConfig["simulation"]["banana"]["energy"].toDouble())
// animal
    ...
    , animal_deadTexture(mConfig["simulation"]["animal"]["deadTexture"].toString())
    
//fireball
    , fireball_texture(mConfig["simulation"]["fireball"]["texture"].toString())
