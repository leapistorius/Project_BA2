...
public:
    ...
    const double object_generator_delta; 
	...
	//mushroom
	const std::string mushroom_texture; 
	const double mushroom_size; 
	const double mushroom_energy; 
	const double mushroom_lossEnergy; 

	//banana
	const std::string banana_texture; 
	const double banana_size; 
	const double banana_energy; 

    // animal
    const bool animal_random_walk_low_energy;
    const double animal_seuilEnergie;
    const double animal_tempsPause;
    ...
    const int animal_coefAmp1;
    const int animal_coefAmp2;
    const double animal_distMaxEnemy;
    const std::string animal_deadTexture; 
    const std::string fireball_texture;
    ...
    const double scorpion_idle_time; 
    const double scorpion_moving_time; 
    // sensor
