...
class Animal : public OrganicEntity {
	...
	public:
		...
		sf::Time getCompteurNaissance() const;
	...
	protected: 
		...
		void animalCollisions(OrganicEntity* entity);
		
		void updateEnergie(sf::Time dt);	
		void updateCompteurNaissance(sf::Time dt);
	...
	private: 
		...
		void drawDead(sf::RenderTarget& targetWindow) const; 
