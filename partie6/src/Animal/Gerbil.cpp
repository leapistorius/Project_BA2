...
size_t Gerbil::compteurGerbil(0); 
...
size_t Gerbil::getCompteurGerbil()
{
	return compteurGerbil; 
}
...
bool Gerbil::eatableBy(Banana const* banana) const
{
    return false;
}
...
bool Gerbil::canMate(Banana const* banana) const
{
	return false;
}
...
//methodes objet 
bool Gerbil::upgradable(OrganicEntity const* other) const
{
	return other->canUpgrade(this);
}

bool Gerbil::canUpgrade(Scorpion const* scorpion) const
{
	return false;
}

bool Gerbil::canUpgrade(Gerbil const* gerbil) const
{
	return false;
}

bool Gerbil::canUpgrade(Food const* food) const
{
	return false;
}

bool Gerbil::canUpgrade(Banana const* banana) const
{
	return false;
}
